...
const holdings = [
  ...
  },
  {
    ...
    trend: "金融股偏多",
    support: ["33.6", "33.0"],
    resistance: ["34.5", "35.0"],
    stop: "33.0",
    add: "守住 33.6 並站上 34.5",
    advice: "小幅獲利，守住成本與 33.6 可續抱觀察。",
    detail: ["34.5 以上轉強。", "33.6～34.5 屬於正常整理。", "跌破 33.0 提高警覺。"],
    tech: { ma5: "34.0", ma10: "33.7", ma20: "33.2", kd: "K 62 / D 58", macd: "金融股溫和偏多", volume: "觀察金融族群量能" }
  }
];
...
const alerts = [
  { title: "跌破關鍵價減碼提醒", items: ["台積電跌破 2150：考慮調整", "廣達跌破 360 且站不回：減碼 100～200 股", "廣達跌破 350：危險提醒", "鴻海跌破 270：提高警覺", "大成鋼跌破 41：警戒", "玉山金跌破 33：提高警覺"] },
  { title: "漲太多減碼提醒", items: ["台積電急漲站上 2450 且量縮：提醒獲利減碼", "廣達急漲站上 420 且量縮：提醒分批減碼", "鴻海急漲站上 300 且量縮：提醒獲利減碼", "大成鋼急漲站上 46 且量縮：提醒減碼觀察", "玉山金急漲站上 35 且量縮：提醒減碼觀察"] },
  { title: "後續加碼提醒", items: ["台積電回測 2200 不破並站回 2300：追蹤加碼", "廣達回測 360 不破並站回 390：追蹤加碼", "鴻海守住 270 並站回 290：追蹤加碼", "大成鋼守住 42 並站回 44：追蹤加碼", "玉山金守住 33.6 並站上 34.5：追蹤加碼"] },
